...
<html lang="en">
<head>
<title>Congo Deal - User profile</title>
<meta charset="utf-8">
			...
			<div class="row">
				...
				<div class="col-lg-4 order-3">
					<div class="product_description">
						...
						<div class="product_name">User Name</div>
						...
						<div class="order_info d-flex flex-row ">
							<ul class="list-group list-group-flush w-100">
								<li class="list-group-item list-group-item-action active"> <i class="fa fa-user"></i> Cras justo odio</li>
								<li class="list-group-item list-group-item-action"> <i class="fa fa-phone"></i> Dapibus ac facilisis in</li>
